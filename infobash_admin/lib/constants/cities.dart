...
List<String> getcitiesall(String city) {
  final list = datadiswithall[city]!["cities"] as List<String>;
...
final datadiswithall = {
  ...
  "Kilinochchi": {
    "cities": [selcity, "All" "Kilinochchi"]
  },
  "Kurunegala": {
    "cities": [
      selcity,
